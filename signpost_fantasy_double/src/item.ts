...
export default class SignPost implements IScript<Props> {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    sign.addComponent(new GLTFShape('models/signpost/SignPost_Tree_Double.glb'))
    ...
    signTextTop.addComponent(
      new Transform({
        position: new Vector3(-0.7, 2.025, 0.05),
        rotation: Quaternion.Euler(0, 175, 0),
    ...
    signTextLower.addComponent(
      new Transform({
        position: new Vector3(0.7, 1.3, 0.05),
        rotation: Quaternion.Euler(0, 176.25, 0),
        scale: new Vector3(0.05, 0.05, 0.05)
      })
    )
    ...
    signTextLower2.addComponent(
      new Transform({
        position: new Vector3(0.7, 1.3, -0.05),
        rotation: Quaternion.Euler(0, -3.75, 0),
        scale: new Vector3(0.05, 0.05, 0.05)
      })
    )
