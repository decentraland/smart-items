...
export class TriggerableTileSciFi {
  lastState: 0 | 1 = 0
...
export class TriggerableTileSciFiSystem implements ISystem {
  group = engine.getComponentGroup(TriggerableTileSciFi)

  update(_: number) {
    for (const entity of this.group.entities) {
      const triggerableArea = entity.getComponent(TriggerableTileSciFi)
