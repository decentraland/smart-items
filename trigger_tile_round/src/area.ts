...
@Component('org.decentraland.TriggerableTileRound')
export class TriggerableTileRound {
  lastState: 0 | 1 = 0
...
export class TriggerableTileRoundSystem implements ISystem {
  group = engine.getComponentGroup(TriggerableTileRound)

  update(_: number) {
    for (const entity of this.group.entities) {
      const triggerableArea = entity.getComponent(TriggerableTileRound)
