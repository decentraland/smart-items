...
export default class Button implements IScript<Props> {
  ...
  toggle(entity: Entity, value: boolean, silent?: boolean) {
    ...
    const switchClip = animator.getClip('Speaker_Action')
    const lightClip = animator.getClip('Click_Action')
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    const switchClip = new AnimationState('Speaker_Action', { looping: false })
    const lightClip = new AnimationState('Click_Action', { looping: true })
